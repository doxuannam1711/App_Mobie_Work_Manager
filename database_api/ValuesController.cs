...
public class ValuesController : ApiControllerBase
{
    ...
    public IHttpActionResult GetKien()
    {
        try
        {
            ...
            Command.CommandText = @"SELECT * from users where UserID=1";
...
cards.Description, cards.Activity, cards.IntCheckList, cards.LabelColor;";
    ...
    public IHttpActionResult GetNotifications()
    {
        ...
        {
            Command.ResetAndOpen(CommandType.Text);
            Command.CommandText = @"SELECT DISTINCT notifications.NotificationID, notifications.NotificationType, Content, notifications.CreatedDate, users.Username, boards.BoardName, cards.CardName
FROM notifications
